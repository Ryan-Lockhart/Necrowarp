...
namespace necrowarp::characters {
	...
	constexpr const u8 MistLady{ 0x1F };
	...
	constexpr const u8 Berserker{ 0x25 };
	constexpr const u8 BloodyBerserker{ 0x26 };
	constexpr const u8 IchorousBerserker{ 0x27 };
	constexpr const u8 BloodyIchorousBerserker{ 0x28 };

	constexpr const u8 Paladin{ 0x29 };

	constexpr const u8 FreshSkull{ 0x2A };
	constexpr const u8 AnimateSkull{ 0x2B };
	constexpr const u8 RottedSkull{ 0x2C };

	constexpr const u8 Flesh{ 0x2D };

	constexpr const u8 HealthyCerebrum{ 0x2E };
	constexpr const u8 StrickenCerebrum{ 0x2F };

	constexpr const u8 UpLadder{ 0x30 };
	constexpr const u8 DownLadder{ 0x31 };

	constexpr const u8 Floor{ 0x00 };

	constexpr const u8 RightPatch{ 0x32 };
	constexpr const u8 LeftPatch{ 0x33 };

	constexpr const u8 AltRightPatch{ 0x34 };
	constexpr const u8 AltLeftPatch{ 0x35 };
} // namespace necrowarp::characters
