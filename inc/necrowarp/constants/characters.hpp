...
namespace necrowarp::characters {
	...
	constexpr const u8 NeonatalThetwo{ 0x00 };
	constexpr const u8 YoungThetwo{ 0x00 };
	constexpr const u8 MatureThetwo{ 0x00 };
	constexpr const u8 GrossThetwo{ 0x00 };
	constexpr const u8 TitanicThetwo{ 0x00 };
