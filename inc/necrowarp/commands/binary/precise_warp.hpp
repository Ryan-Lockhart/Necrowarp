...
namespace necrowarp {
	...
	template<> struct is_command<precise_warp_t> {
		static constexpr bool value = true;
	};

	template<> struct is_binary_command<precise_warp_t> {
		static constexpr bool value = true;
	};
	...
	template<> struct to_command_enum<precise_warp_t> {
		static constexpr command_e value = command_e::PreciseWarp;
	};

	template<NonNullEntity EntityType> struct entity_command_t<EntityType, precise_warp_t> {
		using entity_type = EntityType;
		using command_type = precise_warp_t;
