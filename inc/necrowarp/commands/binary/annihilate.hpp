...
namespace necrowarp {
	...
	template<> struct is_grimoire<annihilate_t> {
		static constexpr bool value = true;
	};

	template<> struct to_grimoire_enum<annihilate_t> {
		static constexpr grimoire_e value = grimoire_e::Annihilate;
	};
	...
	template<Entity EntityType> struct entity_command_t<EntityType, annihilate_t> {
