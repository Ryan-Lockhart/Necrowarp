...
namespace necrowarp {
	template<NonNullEntity EntityType> inline void entity_command_t<EntityType, sanguine_invocation_t>::process() noexcept {
		...
		if (fluid_map[player.position].contains(fluid_type_e::Blood)) {
