...
namespace necrowarp {
	...
	struct anchor_t {
		...
		explicit constexpr anchor_t(offset_t position, cardinal_t alignment) noexcept : position{ position }, alignment{ alignment } {}
	...
	struct border_t {
		...
		explicit constexpr border_t(color_t color, extent_t::scalar_t thickness) noexcept : color{ color }, thickness{ thickness } {}
	};
} // namespace necrowarp
