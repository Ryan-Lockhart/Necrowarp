...
namespace necrowarp {
	template<> struct phase_state_t<phase_e::NewGame> {
		...
		static inline void update(button_e button) noexcept {
			...
			no_patron_toggle.update(button_e::Left,
				&rathghul_toggle,
			...
			rathghul_toggle.update(button_e::Left,
				&no_patron_toggle,
				&akurakhaithan_toggle,
				&merirfin_toggle,
				&saeiligarkeuss_toggle
			...
			akurakhaithan_toggle.update(button_e::Left,
				&no_patron_toggle,
				&rathghul_toggle,
				&merirfin_toggle,
				&saeiligarkeuss_toggle
			...
			merirfin_toggle.update(button_e::Left,
				&no_patron_toggle,
				&rathghul_toggle,
				&akurakhaithan_toggle,
				&saeiligarkeuss_toggle
			...
			saeiligarkeuss_toggle.update(button_e::Left,
				&no_patron_toggle,
				&rathghul_toggle,
				&akurakhaithan_toggle,
				&merirfin_toggle
