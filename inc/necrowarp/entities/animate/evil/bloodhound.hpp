	...
	struct bloodhound_t {
		...
		struct hasher {
			struct offset {
				...
				static constexpr usize operator()(cref<bloodhound_t> bloodhound) noexcept { return offset_t::hasher::operator()(bloodhound.position); }
		...
		struct comparator {
			struct offset {
				...
				static constexpr bool operator()(cref<bloodhound_t> lhs, cref<bloodhound_t> rhs) noexcept { return offset_t::hasher::operator()(lhs.position) == offset_t::hasher::operator()(rhs.position); }

				static constexpr bool operator()(cref<bloodhound_t> lhs, offset_t rhs) noexcept { return offset_t::hasher::operator()(lhs.position) == offset_t::hasher::operator()(rhs); }

				static constexpr bool operator()(offset_t lhs, cref<bloodhound_t> rhs) noexcept { return offset_t::hasher::operator()(lhs) == offset_t::hasher::operator()(rhs.position); }
			};
		};
	};
} // namespace necrowarp
