...
namespace necrowarp {
	...
	template<map_type_e MapType, death_e Death> inline death_info_t<Death> berserker_t::die(offset_t position) noexcept {
		++steam_stats::stats<stat_e::BerserkersSlain>;
