...
namespace necrowarp {
	template<map_type_e MapType> inline command_pack_t thetwo_t::think(offset_t position) const noexcept {
		...
		cauto further_descent_pos{ good_goal_map<MapType>.dependent descend<region_e::Interior>(descent_pos.value(), entity_registry<MapType>) };
	...
	template<map_type_e MapType> inline void thetwo_t::die(offset_t position) noexcept {
