...
namespace necrowarp {
	...
	template<map_type_e MapType> inline void banner_bearer_t::killed(offset_t position) noexcept {
	...
	template<map_type_e MapType> inline i8 banner_bearer_t::devoured(offset_t position) noexcept {
		object_registry<MapType>.spill(position, bones_t{});
		object_registry<MapType>.spill(position, cerebra_t{ entity_e::BannerBearer });
