...
namespace necrowarp {
	template<map_type_e MapType> inline command_pack_t bloodhound_t::think() const noexcept {
		...
		cauto further_descent_pos{ evil_goal_map<MapType>.dependent descend<zone_region_e::Interior>(descent_pos.value(), entity_registry<MapType>) };
