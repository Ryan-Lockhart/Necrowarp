...
namespace necrowarp {
	...
	public:
		...
		inline void draw() const noexcept { entity_atlas.draw(entity_glyphs<wraith_t>, position); }

		inline void draw(offset_t offset) const noexcept { entity_atlas.draw(entity_glyphs<wraith_t>, position, offset); }

		inline void draw(cref<camera_t> camera) const noexcept { entity_atlas.draw(entity_glyphs<wraith_t>, position + camera.get_offset()); }

		inline void draw(cref<camera_t> camera, offset_t offset) const noexcept { entity_atlas.draw(entity_glyphs<wraith_t>, position + camera.get_offset(), offset); }
