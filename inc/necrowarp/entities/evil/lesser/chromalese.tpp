...
#include <necrowarp/entities/evil/lesser/chromalese.hpp>

#include <necrowarp/entity_state.hpp>
#include <necrowarp/entity_state.tpp>

namespace necrowarp {
	template<map_type_e MapType> inline command_pack_t chromalese_t::think(offset_t position) const noexcept {
	...
	template<map_type_e MapType, death_e Death> inline death_info_t<Death> chromalese_t::die(offset_t position) noexcept {
