...
namespace necrowarp {
	template<map_type_e MapType> inline command_pack_t furtive_horror_t::think(offset_t position) const noexcept {
	...
	template<map_type_e MapType, death_e Death> inline death_info_t<Death> furtive_horror_t::die(offset_t position) noexcept {
