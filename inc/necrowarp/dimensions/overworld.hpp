...
namespace necrowarp {
	template<> inline void game_s::load<dimension_e::Overworld>() noexcept {}

	template<> inline void game_s::descend<dimension_e::Overworld>() noexcept {}

	template<> inline void game_s::plunge<dimension_e::Overworld>() noexcept {
		constexpr map_type_e MapType = determine_map<dimension_e::Overworld>();
	...
	template<> inline void game_s::process_turn<dimension_e::Overworld>() noexcept {}

	template<> inline void game_s::unload<dimension_e::Overworld>() noexcept {
		constexpr map_type_e MapType = determine_map<dimension_e::Overworld>();
