...
namespace necrowarp {
	template<> inline void game_s::load<dimension_e::Yyndikras>() noexcept {}

	template<> inline void game_s::descend<dimension_e::Yyndikras>() noexcept {}

	template<> inline void game_s::plunge<dimension_e::Yyndikras>() noexcept {
		constexpr map_type_e MapType = determine_map<dimension_e::Yyndikras>();
	...
	template<> inline void game_s::process_turn<dimension_e::Yyndikras>() noexcept {}

	template<> inline void game_s::unload<dimension_e::Yyndikras>() noexcept {
		constexpr map_type_e MapType = determine_map<dimension_e::Yyndikras>();
